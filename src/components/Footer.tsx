    ...
    <footer className="bg-slate-950 text-slate-400 border-t border-slate-800 pt-16 pb-12">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="lg:col-span-2 space-y-4">
            ...
            <div className="pt-2">
              ...
              <div className="flex items-center gap-3">
                <a href="https://instagram.com" target="_blank" rel="noreferrer" className="w-9 h-9 rounded-lg bg-slate-900 hover:bg-pink-600/20 hover:text-pink-400 border border-slate-800 hover:border-pink-500/50 flex items-center justify-center transition-colors" title="Instagram">
                ...
                <a href="https://wa.me/923397100515" target="_blank" rel="noreferrer" className="w-9 h-9 rounded-lg bg-slate-900 hover:bg-emerald-600/20 hover:text-emerald-400 border border-slate-800 hover:border-emerald-500/50 flex items-center justify-center transition-colors" title="WhatsApp Business"><MessageCircle className="w-4 h-4" /></a>
                <a href="https://facebook.com" target="_blank" rel="noreferrer" className="w-9 h-9 rounded-lg bg-slate-900 hover:bg-blue-600/20 hover:text-blue-400 border border-slate-800 hover:border-blue-500/50 flex items-center justify-center transition-colors" title="Facebook"><svg className="w-4 h-4 fill-current" viewBox="0 0 24 24"><path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z"/></svg></a>
                <a href="https://tiktok.com" target="_blank" rel="noreferrer" className="w-9 h-9 rounded-lg bg-slate-900 hover:bg-cyan-600/20 hover:text-cyan-400 border border-slate-800 hover:border-cyan-500/50 flex items-center justify-center transition-colors" title="TikTok"><span className="font-bold text-xs">TT</span></a>
                <a href="https://linkedin.com" target="_blank" rel="noreferrer" className="w-9 h-9 rounded-lg bg-slate-900 hover:bg-sky-600/20 hover:text-sky-400 border border-slate-800 hover:border-sky-500/50 flex items-center justify-center transition-colors" title="LinkedIn"><svg className="w-4 h-4 fill-current" viewBox="0 0 24 24"><path d="M19 0h-14c-2.761 0-5 2.239-5 5v14c0 2.761 2.239 5 5 5h14c2.762 0 5-2.239 5-5v-14c0-2.761-2.238-5-5-5zm-11 19h-3v-11h3v11zm-1.5-12.268c-.966 0-1.75-.79-1.75-1.764s.784-1.764 1.75-1.764 1.75.79 1.75 1.764-.783 1.764-1.75 1.764zm13.5 12.268h-3v-5.604c0-3.368-4-3.113-4 0v5.604h-3v-11h3v1.765c1.396-2.586 7-2.777 7 2.476v6.759z"/></svg></a>
                <a href="https://youtube.com" target="_blank" rel="noreferrer" className="w-9 h-9 rounded-lg bg-slate-900 hover:bg-rose-600/20 hover:text-rose-400 border border-slate-800 hover:border-rose-500/50 flex items-center justify-center transition-colors" title="YouTube"><svg className="w-4 h-4 fill-current" viewBox="0 0 24 24"><path d="M23.498 6.186a3.016 3.016 0 0 0-2.122-2.136C19.505 3.545 12 3.545 12 3.545s-7.505 0-9.377.505A3.017 3.017 0 0 0 .502 6.186C0 8.07 0 12 0 12s0 3.93.502 5.814a3.016 3.016 0 0 0 2.122 2.136c1.871.505 9.376.505 9.376.505s7.505 0 9.377-.505a3.015 3.015 0 0 0 2.122-2.136C24 15.93 24 12 24 12s0-3.93-.502-5.814zM9.545 15.568V8.432L15.818 12l-6.273 3.568z"/></svg></a>
              </div>
            </div>
          </div>
        ...
        <div className="pt-8 flex flex-col sm:flex-row items-center justify-between gap-4 text-xs text-slate-400">
          <p>© {new Date().getFullYear()} sastamaal.net. All rights reserved. Built for Pakistan E-Commerce.</p>
          <div className="flex flex-wrap items-center gap-4 text-slate-400">
            {POLICY_LINKS.map((link, i) => (
              <React.Fragment key={link.href}>
                {i > 0 && <span>•</span>}
                <Link href={link.href} className="hover:text-emerald-400 transition">{link.label}</Link>
              </React.Fragment>
            ))}
          </div>
        </div>
