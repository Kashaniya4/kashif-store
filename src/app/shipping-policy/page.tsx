  ...
  return (
    <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-16 space-y-8">
      <div className="space-y-3">
        <span className="text-xs font-bold uppercase tracking-widest text-emerald-600">Shipping Policy</span>
      ...
      <div className="rounded-3xl border border-slate-200 bg-white/60 p-6 space-y-3">
        ...
        <p className="text-sm text-slate-700">Contact support if your shipment is delayed or you want a tracking update.</p>
        <div className="flex flex-wrap gap-3 text-xs">
          <Link href="/contact" className="px-4 py-2 rounded-xl bg-emerald-500 text-slate-50 font-bold">Contact Support</Link>
          <Link href="/return-policy" className="px-4 py-2 rounded-xl border border-slate-300 text-slate-900">Return Policy</Link>
        </div>
      </div>
    </div>
  );
