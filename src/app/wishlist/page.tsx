  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10 pb-20">
      ...
      <nav className="flex items-center gap-2 text-xs text-slate-500 mb-6">
        ...
        <span>/</span>
        <span className="text-slate-700">My Wishlist</span>
      </nav>
      ...
      {wishlistProducts.length === 0 ? (
        <div className="text-center py-24 space-y-4 bg-white/30 border border-slate-200/60 rounded-3xl p-8 max-w-lg mx-auto">
          <div className="w-16 h-16 rounded-full bg-rose-500/10 border border-rose-500/20 flex items-center justify-center text-rose-600 mx-auto">
          ...
          <Link
            href="/products"
            className="inline-flex items-center gap-2 px-6 py-3 rounded-xl bg-emerald-500 hover:bg-emerald-400 text-slate-50 font-bold text-xs uppercase tracking-wider transition shadow-lg shadow-emerald-500/20"
          >
