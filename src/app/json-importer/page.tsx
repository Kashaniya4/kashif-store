  ...
  return (
    <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-12 space-y-10">
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 border-b border-slate-200 pb-6">
        <div>
          <Link href="/admin" className="inline-flex items-center gap-2 text-xs font-semibold text-slate-600 hover:text-emerald-600 mb-2">
        ...
        <div className="text-xs bg-white border border-slate-200 rounded-xl px-4 py-2 text-slate-700">
          <span className="text-slate-500">Current Catalog:</span>{' '}
          <strong className="text-emerald-600">{products.length} products</strong>
        </div>
      </div>

      {/* Success Toast */}
      {isImported && (
        <div className="p-4 rounded-2xl bg-emerald-950/60 border border-emerald-600/60 text-emerald-700 text-xs font-semibold flex items-center gap-2">
      ...
      <div className="bg-white border border-slate-200 rounded-3xl p-6 space-y-4">
        ...
        <div className="flex items-center justify-between">
          ...
          <label className="px-3.5 py-2 rounded-xl bg-slate-100 hover:bg-slate-200 text-slate-900 font-bold text-xs border border-slate-300 cursor-pointer transition flex items-center gap-1.5">
        ...
        <textarea
          ...
          className="w-full bg-slate-50 text-emerald-700 text-xs font-mono rounded-xl p-4 border border-slate-200 focus:outline-none focus:border-emerald-500 resize-y placeholder:text-slate-600"
        />
        ...
        <div className="flex gap-3">
          <button
            ...
            className="px-5 py-2.5 rounded-xl bg-slate-100 hover:bg-slate-200 text-slate-900 font-bold text-xs border border-slate-300 transition disabled:opacity-50 disabled:cursor-not-allowed"
          >
            Validate & Preview
          </button>
          {parsedProducts && (
            <button
              ...
              className="px-5 py-2.5 rounded-xl bg-gradient-to-r from-emerald-500 to-teal-500 hover:from-emerald-400 hover:to-teal-400 text-slate-50 font-black text-xs flex items-center gap-2 transition shadow-lg shadow-emerald-500/20"
            >
        ...
        {/* Parse Error */}
        {parseError && (
          <div className="p-4 rounded-2xl bg-rose-50/60 border border-rose-800 text-rose-300 text-xs font-semibold flex items-start gap-2">
        ...
        <div className="space-y-4">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
            {parsedProducts.map((p, i) => {
              ...
              return (
                <div key={p.id} className="bg-white border border-slate-200 rounded-2xl p-4 space-y-2 relative">
                  {exists && (
          ...
          {parsedProducts.some(p => p.specs === undefined || p.tags === undefined) && (
            <div className="p-3 rounded-2xl bg-amber-950/40 border border-amber-800 text-amber-600 text-xs flex items-center gap-2">
      ...
      {/* Sample template */}
      <div className="p-4 rounded-2xl bg-white/60 border border-slate-200 text-xs space-y-2">
        <div className="flex items-center justify-between">
        ...
        <div className="text-slate-500 font-mono bg-slate-50 p-3 rounded-xl border border-slate-200 overflow-x-auto">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
        <div className="p-4 rounded-2xl bg-white border border-slate-200 space-y-1">
          <div className="text-xs text-slate-600 font-semibold flex items-center gap-2">
            <Package className="w-4 h-4 text-emerald-600" /> Live Catalog Size
          </div>
        ...
        <div className="p-4 rounded-2xl bg-white border border-slate-200 space-y-1">
          <div className="text-xs text-slate-600 font-semibold flex items-center gap-2">
            <CheckCircle2 className="w-4 h-4 text-emerald-600" /> Categories
          </div>
        ...
        <div className="p-4 rounded-2xl bg-white border border-slate-200 space-y-1">
          <div className="text-xs text-slate-600 font-semibold flex items-center gap-2">
            <Trash2 className="w-4 h-4 text-emerald-600" /> Persistence
          </div>
          <div className="text-sm font-black text-slate-900">localStorage</div>
