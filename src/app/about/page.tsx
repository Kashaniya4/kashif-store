  ...
  return (
    <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-16 space-y-8">
      <div className="space-y-3">
        <span className="text-xs font-bold uppercase tracking-widest text-emerald-600">About Us</span>
        <h1 className="text-3xl font-black text-slate-900">About sastamaal.net</h1>
      ...
      <section className="rounded-3xl border border-slate-200 bg-white/60 p-6 space-y-3">
        <h2 className="text-xl font-bold text-slate-900">Why customers use sastamaal.net</h2>
        ...
        <div className="flex flex-wrap gap-3 text-xs">
          ...
          <Link href="/contact" className="px-4 py-2 rounded-xl border border-slate-300 text-slate-900">Contact Support</Link>
        </div>
      </section>
    </div>
  );
